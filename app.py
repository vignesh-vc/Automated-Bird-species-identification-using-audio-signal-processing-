...
def predict():
    ...
    if f.filename == '' or Path('/tmp/audio'+ip_address+'.wav').is_file():
        if Path('tmp/audio'+ip_address+'.wav').is_file():
            ...
            if max_prob>0.7:
                output = prediction[0]
                if output == 'Cardinal The male Northern Cardinal is perhaps responsible for getting more people to open up a field guide than any other bird. They’re a perfect combination of familiarity, conspicuousness, and style: a shade of red you can’t take your eyes off. Even the brown females sport a sharp crest and warm red accents.':
                ...
                if output == 'Mourning Dove The mourning dove is a member of the dove family, Columbidae. The bird is also known as the American mourning dove, the rain dove, and colloquially as the turtle dove, and it was once known as the Carolina pigeon and Carolina turtledove.':
                ...
                if output == 'Pigeon Columbidae is a bird family consisting of doves and pigeons. It is the only family in the order Columbiformes. These are stout-bodied birds with short necks and short slender bills that in some species feature fleshy ceres. They primarily feed on seeds, fruits, and plants':
